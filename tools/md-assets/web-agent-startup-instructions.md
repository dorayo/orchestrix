...
- `==================== START: .orchestrix-core/folder/filename.md ====================`
- `==================== END: .orchestrix-core/folder/filename.md ====================`

When you need to reference a resource mentioned in your instructions:

- Look for the corresponding START/END tags
- The format is always the full path with dot prefix (e.g., `.orchestrix-core/personas/analyst.md`, `.orchestrix-core/tasks/create-story.md`)
...
- `dependencies.utils: template-format` → Look for `==================== START: .orchestrix-core/utils/template-format.md ====================`
- `dependencies.utils: create-story` → Look for `==================== START: .orchestrix-core/tasks/create-story.md ====================`
