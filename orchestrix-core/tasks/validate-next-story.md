...
- Identify and load the following inputs:
  ...
  - **Story template**: `orchestrix-core/templates/story-tmpl.md` for completeness validation

### 1. Template Completeness Validation

- Load `orchestrix-core/templates/story-tmpl.md` and extract all section headings from the template
