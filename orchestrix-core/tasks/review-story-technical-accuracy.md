...
### 3. Review
Execute: `common/tasks/execute-checklist.md`
...
## Refs
`architect-technical-review-checklist.md` | `architect-review-result.yaml` | `load-architecture-context.md` | `validate-status-transition.md`
