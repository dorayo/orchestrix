...
# 窗口4 - QA 再次审查（自动创建 Git Commit）
@qa
*review story-001

# QA 输出（通过 + 自动提交）：
# ✅ STORY COMPLETE
# Story: story-001 → Status: Done
# Gate: PASS | Quality: 90/100
#
# 📦 Git Commit: abc123def
#    Message: feat(story-001): user authentication
#    Files: 8 modified, 4 tests added
#
# 🎉 STORY story-001 DONE - COMMITTED AND READY FOR DEPLOYMENT ✅

# 注意：Git commit 现在是自动执行的！
# 如果 commit 失败，QA 会提示使用 *finalize-commit story-001 重试
```
