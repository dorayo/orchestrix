---
description: "Architect Review Story - Technical Accuracy"
---
...
Execute `.orchestrix-core/tasks/util-load-architecture-context.md`:
...
test_design_routing:
  ...
  IF review fails: → Set Status to RequiresRevision or Escalated
    → HANDOFF to SM
```
