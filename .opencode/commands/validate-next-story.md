---
description: "Validate Next Story Task (PO Business Validation Tool)"
---
...
- SM technical validation (use scoring/sm-story-quality.md instead)
...
```
SM Technical Validation (scoring/sm-story-quality.md)
         ↓
