---
description: "Check Cross-Repo Dependencies (Utility)"
---
...
Execute: `.orchestrix-core/tasks/util-check-cross-repo-dependencies.md`
...
- Path: `.orchestrix-core/../../tools/utils/dependency-checker.js` (relative to orchestrix-core)
