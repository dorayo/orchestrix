...
Use template: `.orchestrix-core/templates/qa-idempotency-messages.yaml`
...
Execute: `.orchestrix-core/tasks/util-detect-project-type.md`
...
Execute: `.orchestrix-core/tasks/qa-environment-setup.md`
...
Execute: `.orchestrix-core/tasks/qa-e2e-testing.md`
...
**Load**: `.orchestrix-core/data/blind-spot-categories.yaml`
...
Execute: `.orchestrix-core/tasks/qa-collect-evidence.md`
...
Execute: `.orchestrix-core/tasks/qa-environment-cleanup.md`
...
**Template**: `.orchestrix-core/templates/qa-gate-tmpl.yaml`
...
Execute: `.orchestrix-core/tasks/util-validate-status-transition.md`
