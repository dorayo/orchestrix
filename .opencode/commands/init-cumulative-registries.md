---
description: "Initialize Cumulative Registries"
---
...
Use template structure from `.orchestrix-core/templates/database-registry-tmpl.yaml`
...
Use template structure from `.orchestrix-core/templates/api-registry-tmpl.yaml`

Output file: `{devDocLocation}/api-registry.md`

**6.3 Generate Models Registry Markdown**:

Use template structure from `.orchestrix-core/templates/models-registry-tmpl.yaml`
